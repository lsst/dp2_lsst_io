...
At left, click on “Spatial” and add constraints (a cone search) centered on RA, Dec = 53.13, -28.10 deg (orange arrow in Figure 1). Limit the radius to 10 arcseconds.
...
Note: the extra steps of selecting all rows and deselecting is to minimize the number of items selected for this particular search.
