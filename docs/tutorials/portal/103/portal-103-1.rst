...
Enter **53.13, -28.1** into the Spatial constraints box (orange arrow in Figure 1).
Click the check box above the funnel icon (orange circle in Figure 1) to select all, and then again to deselect all items in the table.
To choose the items to include in the ADQL query, select **coord_ra**, **coord_dec**, and then scroll down to select **g_psfFlux**.
