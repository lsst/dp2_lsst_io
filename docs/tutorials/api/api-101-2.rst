...
This query will retrieve the RA/DEC of each of the Coadd Patches within DP2. A temporary window, called "Load New Table", will appear will appear with a status bar.
This window will close when the table is loaded and a new table name should appear in the main TOPCAT window. The query should take a few seconds to run.
