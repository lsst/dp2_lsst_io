...
This step will verify TOPCAT can to send information to ds9 or Aladin.
...
TOPCAT will retrieve a table called SIA-30m) (whic are the relevant sections of the ObsCore table) (Figure 6).  The table retrieved by TOPCAT has 132 rows and 37 columns.
