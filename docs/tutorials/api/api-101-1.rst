...
To view the table of results, find the in the "Table List" panel of the main TOPCAT window , and then click on the "Display table cell data" icon (see Figure 9 red circle).
