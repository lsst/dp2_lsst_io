...
**Credit:** Originally developed by the Rubin Community Science team. Please consider acknowledging them if this
...
.. figure:: images/api-101-1-4.png
    ...
    available for query can be seen in the Metadata panel.
...
To view the table of results, find the "Table List" panel of the main TOPCAT window, select table to view (in this instance only one table is available),
