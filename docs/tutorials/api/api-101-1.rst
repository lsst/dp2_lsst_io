...
Note: Under TAP service, the file structure may list dp02 and dp1 catalogs first.  DP2 tables can be found by collapsing those folders or using the scroll bar.
