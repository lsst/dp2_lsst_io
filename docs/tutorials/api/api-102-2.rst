...
Execute a search query to retrieve images that overlap the specified region. Limit the results to derived data product images (``calib_level=3``) and restrict the number of results to 5.
