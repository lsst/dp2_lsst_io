...
The DP2 ``SSSource`` table does *not* include unassociated detections, and its ephemeris quantities are *not* a Rubin-derived orbit solution.
...
For further information on the algorithm and selection effects, see the :doc:`source detection and association </processing/moving/ss_association>` documentation.
