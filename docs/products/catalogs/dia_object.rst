...
The DIA object table contains derived per-filter variability parameters such as the minimum, mean, maximum and standard deviation of the difference-image fluxes, and the light-curve's maximum slope.
