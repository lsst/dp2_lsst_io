...
The metadetection algorithm involves applying small artificial shear to images of small regions of sky and performing detection on the sheared images, as well as measurements that are used to calculate a shear response (`Sheldon et al. 2020 <https://scixplorer.org/abs/2020ApJ...902..138S/abstract>`_, `Sheldon et al. 2023 <https://scixplorer.org/abs/2023OJAp....6E..17S/abstract>`_, `Yamamoto et al. 2025 <https://scixplorer.org/abs/2025MNRAS.543.4156Y/abstract>`_).
