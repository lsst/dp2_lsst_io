...
The ``epoch`` provided in the :doc:`mpc_orbits </products/catalogs/mpc_orbits>` catalog is the only time measurement that is not measured in TAI, but Terrestrial Time (TT).
