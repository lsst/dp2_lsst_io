...
The ``GalSim`` ``Shear`` class is used to create four "counterfactual" versions of the deep coadd images with different artificial linear shears introduced, using the "reduced shear" option with a step value (``g1``, ``g2``) of +0.01 or -0.01 (`GalSim documentation <https://galsim-developers.github.io/GalSim/_build/html/overview.html>`_; `Sheldon et al. 2023 <https://scixplorer.org/abs/2023OJAp....6E..17S/abstract>`_).
...
Two approaches are used for measurement (`Yamamoto et al. 2025 <https://scixplorer.org/abs/2025MNRAS.543.4156Y/abstract>`_).
