...
Each ``SSSource`` table contains additional useful computed quantities for previously known Solar System objects that have been linked to measured ``DIASource`` photometry and astrometry.
