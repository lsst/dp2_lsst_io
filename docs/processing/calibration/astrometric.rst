...
Astrometric calibration uses the ``gbdes`` package (`Bernstein et al. 2017 <https://scixplorer.org/abs/2017PASP..129g4503B/abstract>`_).
...
These wave-like astrometric effects can be modeled by a Gaussian Process (`Fortino et al. 2021 <https://scixplorer.org/abs/2021AJ....162..106F/abstract>`_, `Léget et al. 2021 <https://scixplorer.org/abs/2021A%26A...650A..81L/abstract>`_).
